...
* section[sectionAdvanceDirectives] ^short = "Willenserklärungen und andere juridische Dokumente (Advance Directives)"
...
* section[sectionPastIllnessHx] ^short = "Vergangene Gesundheitsprobleme und Risiken (History of Past Problems)"
