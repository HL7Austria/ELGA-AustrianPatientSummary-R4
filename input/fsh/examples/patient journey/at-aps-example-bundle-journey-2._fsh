...
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-specimen-1
// * entry[+].fullUrl = "urn:uuid:ee1e26a1-caba-45f7-928e-d93fc1a47da9"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-specimen-2
// Diagnostic Results
// * entry[+].fullUrl = "urn:uuid:725bcf71-22e6-473b-a879-49a4b63cd654"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-1
// * entry[+].fullUrl = "urn:uuid:aeff2319-2cc2-4fba-9541-7a4de3d20f91"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-2
// * entry[+].fullUrl = "urn:uuid:d16dce15-bc5a-48a5-910e-6ac039785a2a"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-3
// * entry[+].fullUrl = "urn:uuid:96314fcd-3b0c-4032-8cac-6eb59579d90a"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-4
// * entry[+].fullUrl = "urn:uuid:30c8a990-ea39-4dcb-9e1e-b9ac74afffc9"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-5
// * entry[+].fullUrl = "urn:uuid:f29ac02d-762e-436e-b40c-667ab89e15f2"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-6
// * entry[+].fullUrl = "urn:uuid:28a773ea-38c7-4c77-86c4-7764325756e7"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-7
// * entry[+].fullUrl = "urn:uuid:4fe4b16a-14cb-4fd6-9da6-02c4b3797fdc"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-8
// * entry[+].fullUrl = "urn:uuid:24ff8632-0ccd-4279-88b2-325fdd936ecb"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-9
// * entry[+].fullUrl = "urn:uuid:8c11ad58-94ec-469c-ba4d-bfba9063067d"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-10
// * entry[+].fullUrl = "urn:uuid:8c7f9e94-b834-474e-818c-bbd6c3ce3e17"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-11
// * entry[+].fullUrl = "urn:uuid:e6e05f94-92be-4ae3-bf49-b0b7d4a62b35"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-12
// * entry[+].fullUrl = "urn:uuid:33e09da2-5f43-4046-b2eb-cf190031826b"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-13
// * entry[+].fullUrl = "urn:uuid:b675680e-9469-41b1-adc1-093904e3a1d2"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-14
// * entry[+].fullUrl = "urn:uuid:b675680e-9469-41b1-adc1-093904e3a1d3"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-15
// // Diagnostic Results - Performer
// * entry[+].fullUrl = "urn:uuid:82f802a7-56a9-49b4-a675-95da08f0d7a6"
// * entry[=].resource = AtApsExampleBundle-Journey-2-diagnostic-result-performer-1
// Vital Signs
...
* section[sectionMedications].entry[+] = Reference(urn:uuid:6d15d84f-2faf-4141-ac0c-fb9cf8496abe) "RAMIPRIL 1A TBL  5MG (AtApsExampleBundle-Journey-2-medication-summary-7)"
...
* section[sectionProceduresHx].entry[0] = Reference(urn:uuid:75c46c35-8f4e-4232-b026-5672c60d076a) "Totalersatz des linken Hüftgelenks (AtApsExampleBundle-Journey-2-procedure-history-1)"
...
* section[sectionPastIllnessHx].entry[+] = Reference(urn:uuid:ce2589a2-a5e5-4520-808f-8118e2863a95) "Zustand nach Windpocken (AtApsExampleBundle-Journey-2-illness-history-2)"
...
Instance: AtApsExampleBundle-Journey-2-problem-1
...
Instance: AtApsExampleBundle-Journey-2-problem-2
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
// Type-2-Diabetes
Instance: AtApsExampleBundle-Journey-2-problem-3
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-4
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-6
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
// shall this condition be documented? "normal"
Instance: AtApsExampleBundle-Journey-2-problem-7
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-8
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-9
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-10
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-11
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-12
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-14
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-15
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle-Journey-2-problem-16
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $cs-condition-clinical#active "Active"
* verificationStatus = $cs-condition-ver-status#confirmed "Confirmed"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-specimen-1
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-specimen-2
// InstanceOf: AtApsSpecimen
// Usage: #inline
// * subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Maria Musterfrau"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-1
...
// * specimen = Reference(urn:uuid:5218bc54-5d55-42fa-aa0c-169b61577ad0) "AtApsExampleBundle-Journey-2-diagnostic-specimen-1"

// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-2
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
...
// * performer = Reference(urn:uuid:82f802a7-56a9-49b4-a675-95da08f0d7a6) "Amadeus Spital - Labor"
// * hasMember[0] = Reference(urn:uuid:d16dce15-bc5a-48a5-910e-6ac039785a2a) "Cholesterin (AtApsExampleBundle-Journey-2-diagnostic-result-3)"
// * hasMember[+] = Reference(urn:uuid:96314fcd-3b0c-4032-8cac-6eb59579d90a) "HDL-Cholesterin (AtApsExampleBundle-Journey-2-diagnostic-result-4)"
// * hasMember[+] = Reference(urn:uuid:30c8a990-ea39-4dcb-9e1e-b9ac74afffc9) "Cholesterol.gesamt/Cholesterol in HDL in Serum oder Plasma (AtApsExampleBundle-Journey-2-diagnostic-result-5)"
// * hasMember[+] = Reference(urn:uuid:f29ac02d-762e-436e-b40c-667ab89e15f2) "Triglyceride (AtApsExampleBundle-Journey-2-diagnostic-result-6)"
// * hasMember[+] = Reference(urn:uuid:28a773ea-38c7-4c77-86c4-7764325756e7) "Gamma-GT (AtApsExampleBundle-Journey-2-diagnostic-result-7)"
// * hasMember[+] = Reference(urn:uuid:b675680e-9469-41b1-adc1-093904e3a1d3) "Glucose in Blut (AtApsExampleBundle-Journey-2-diagnostic-result-15)"
// * specimen = Reference(urn:uuid:5218bc54-5d55-42fa-aa0c-169b61577ad0) "Blutprobe (AtApsExampleBundle-Journey-2-diagnostic-specimen-1)"

// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-3
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * language = #de-AT
// * status = #final
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-4
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * language = #de-AT
// * status = #final
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-5
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category[0] = $cs-elga-laborparameterergaenzung#05180 "Klinische Chemie"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-6
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * language = #de-AT
// * status = #final
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-7
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * language = #de-AT
// * status = #final
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-8
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// * effectiveDateTime = "2024-02-08T07:56:06+01:00"
// * performer = Reference(urn:uuid:82f802a7-56a9-49b4-a675-95da08f0d7a6) "Amadeus Spital - Labor"
// * hasMember[0] = Reference(urn:uuid:24ff8632-0ccd-4279-88b2-325fdd936ecb) "Leukocytes in Urine (AtApsExampleBundle-Journey-2-diagnostic-result-9)"
// * hasMember[+] = Reference(urn:uuid:8c11ad58-94ec-469c-ba4d-bfba9063067d) "Protein in Urine (AtApsExampleBundle-Journey-2-diagnostic-result-10)"
// * hasMember[+] = Reference(urn:uuid:8c7f9e94-b834-474e-818c-bbd6c3ce3e17) "Glucose in Urine (AtApsExampleBundle-Journey-2-diagnostic-result-11)"
// * hasMember[+] = Reference(urn:uuid:e6e05f94-92be-4ae3-bf49-b0b7d4a62b35) "Blood in Urine by Visual (AtApsExampleBundle-Journey-2-diagnostic-result-12)"
// * hasMember[+] = Reference(urn:uuid:33e09da2-5f43-4046-b2eb-cf190031826b) "Nitrite in Urine (AtApsExampleBundle-Journey-2-diagnostic-result-13)"
// * hasMember[+] = Reference(urn:uuid:b675680e-9469-41b1-adc1-093904e3a1d2) "Urobilinogen in Urine (AtApsExampleBundle-Journey-2-diagnostic-result-14)"
// * specimen = Reference(urn:uuid:ee1e26a1-caba-45f7-928e-d93fc1a47da9) "Urine specimen (AtApsExampleBundle-Journey-2-diagnostic-specimen-2)"

// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-9
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-10
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-11
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-12
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-13
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-14
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $cs-observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-15
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category[0] = $cs-elga-laborparameterergaenzung#05180 "Klinische Chemie"
...
// Instance: AtApsExampleBundle-Journey-2-diagnostic-result-performer-1
