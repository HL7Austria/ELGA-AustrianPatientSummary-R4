...
* section[sectionResults].code = $loinc#30954-2 "Relevante diagnostische Tests und/oder Labordaten"
...
* section[sectionVitalSigns].code = $loinc#8716-3 "Vitalparameter"
...
* section[sectionPastIllnessHx].code = $loinc#11348-0 "Anamnese früherer Krankheiten"
...
* section[sectionSocialHistory].code = $loinc#29762-2 "Sozialanamnese"
...
Instance: AtApsExampleBundle02-author
...
Instance: AtApsExampleBundle02-problem-1
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#700379002 "CKD - Chronische Niereninsuffizienz Grad 3B"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-2
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#711150003 "Langfristige Einnahme von Antikoagulantien"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

// Type-2-Diabetes
Instance: AtApsExampleBundle02-problem-3
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#314194001 "Diabetes mit Insulin und oraler Behandlung"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-4
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#710159007 "Langfristige Einnahme eines Immunsuppressivums"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-5
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
...
Instance: AtApsExampleBundle02-problem-6
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#408570008 "Karotis-Doppler-Sonographie normal"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

// shall this condition be documented? "normal"
Instance: AtApsExampleBundle02-problem-7
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#168938005 "Koronarangiographie normal"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

// shall this condition be documented as medication?
Instance: AtApsExampleBundle02-problem-8
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#328941000119101 "Langfristige aktuelle Anwendung von Bisphosphonaten"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
* onsetPeriod.start = "2020-06"
* onsetPeriod.end = "2025-03"
// * abatementDateTime = "2025-03"

Instance: AtApsExampleBundle02-problem-9
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#440028005 "Dauerhaftes Vorhofflimmern"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-10
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#735623008 "Albuminurie Grad A2"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-11
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#239792003 "Seronegative rheumatoide Arthritis"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-12
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#13644009 "Hypercholesterinämie"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

// Problem List - Family history

Instance: AtApsExampleBundle02-problem-13
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#160303001 "Diabetes mellitus in der Familienanamnese"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-14
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#312824007 "Familienanamnese: Kolonkarzinom"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-15
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#134439009 "Familienanamnese: vorzeitige koronare Herzkrankheit"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-problem-16
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#active "Active"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#160314003 "Hypercholesterinämie in der Familienanamnese"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

// risk of periodontal disease
Instance: AtApsExampleBundle02-problem-17
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#inactive "Inactive"
* verificationStatus = $condition-ver-status#provisional "Provisional"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#2556008 "Parodontalerkrankung"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
* stage.assessment = Reference(urn:uuid:f235c566-01aa-457d-ab49-9e422df69863) "AtApsExampleBundle02-problem-17-assessment-1"

Instance: AtApsExampleBundle02-problem-17-assessment-1
InstanceOf: Observation
Usage: #inline
* status = #final
* category = $observation-category#exam "Exam"
* code = $sct#1237049003 "Bewertung der Risikofaktoren für Parodontalerkrankungen"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
...
* valueCodeableConcept = $sct#723509005 "Hohes Risiko"

// Medication Summary

Instance: AtApsExampleBundle02-medication-summary-1
...
Instance: AtApsExampleBundle02-medication-summary-3
InstanceOf: AtApsMedicationStatement
Usage: #inline
* status = #active
...
Instance: AtApsExampleBundle02-medication-summary-4
InstanceOf: AtApsMedicationStatement
Usage: #inline
* status = #active
...
Instance: AtApsExampleBundle02-medication-summary-5
InstanceOf: AtApsMedicationStatement
Usage: #inline
* status = #active
...
Instance: AtApsExampleBundle02-medication-summary-6
InstanceOf: AtApsMedicationStatement
Usage: #inline
* status = #active
...
Instance: AtApsExampleBundle02-medication-summary-7
InstanceOf: AtApsMedicationStatement
Usage: #inline
* status = #active
...
Instance: AtApsExampleBundle02-medication-summary-8
InstanceOf: AtApsMedicationStatement
Usage: #inline
* status = #active
...
Instance: AtApsExampleBundle02-medication-summary-9
InstanceOf: AtApsMedicationStatement
Usage: #inline
* status = #active
...
Instance: AtApsExampleBundle02-allergy-1
InstanceOf: AtApsAllergyIntolerance
Usage: #inline
* clinicalStatus = $allergyintolerance-clinical#active "Active"
* code = $sct#128488006 "Hausstaub"
* patient = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

// History of Procedures

Instance: AtApsExampleBundle02-procedure-history-1
InstanceOf: AtApsProcedure
Usage: #inline
* status = #completed
* code = $sct#770606008 "Totalersatz des linken Hüftgelenks"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
* performedDateTime = "2010"

Instance: AtApsExampleBundle02-procedure-history-2
InstanceOf: AtApsProcedure
Usage: #inline
* status = #completed
* code = $sct#80146002 "Appendektomie"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
* performedDateTime = "1962"

Instance: AtApsExampleBundle02-procedure-history-3
InstanceOf: AtApsProcedure
Usage: #inline
* status = #completed
* code = $sct#73761001 "Koloskopie"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
...
Instance: AtApsExampleBundle02-diagnostic-specimen-1
InstanceOf: AtApsSpecimen
Usage: #inline
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
* status = $specimen-status#unavailable "Unavailable"
* type = $sct#119297000 "Blutprobe"

// Instance: AtApsExampleBundle02-diagnostic-specimen-2
// InstanceOf: AtApsSpecimen
// Usage: #inline
// * subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
...
Instance: AtApsExampleBundle02-diagnostic-result-1
...
* performer = Reference(urn:uuid:82f802a7-56a9-49b4-a675-95da08f0d7a6) "Amadeus Spital - Labor"
* valueCodeableConcept = $sct#278149003 "Blutgruppe A Rh(D) positiv"
* specimen = Reference(urn:uuid:5218bc54-5d55-42fa-aa0c-169b61577ad0) "AtApsExampleBundle02-diagnostic-specimen-1"

Instance: AtApsExampleBundle02-diagnostic-result-2
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* status = #final
...
* performer = Reference(urn:uuid:82f802a7-56a9-49b4-a675-95da08f0d7a6) "Amadeus Spital - Labor"
* hasMember[0] = Reference(urn:uuid:d16dce15-bc5a-48a5-910e-6ac039785a2a) "AtApsExampleBundle02-diagnostic-result-3"
* hasMember[+] = Reference(urn:uuid:96314fcd-3b0c-4032-8cac-6eb59579d90a) "AtApsExampleBundle02-diagnostic-result-4"
* hasMember[+] = Reference(urn:uuid:30c8a990-ea39-4dcb-9e1e-b9ac74afffc9) "AtApsExampleBundle02-diagnostic-result-5"
* hasMember[+] = Reference(urn:uuid:f29ac02d-762e-436e-b40c-667ab89e15f2) "AtApsExampleBundle02-diagnostic-result-6"
* hasMember[+] = Reference(urn:uuid:28a773ea-38c7-4c77-86c4-7764325756e7) "AtApsExampleBundle02-diagnostic-result-7"
* hasMember[+] = Reference(urn:uuid:b675680e-9469-41b1-adc1-093904e3a1d3) "AtApsExampleBundle02-diagnostic-result-15"
* specimen = Reference(urn:uuid:5218bc54-5d55-42fa-aa0c-169b61577ad0) "AtApsExampleBundle02-diagnostic-specimen-1"

Instance: AtApsExampleBundle02-diagnostic-result-3
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* language = #de-AT
* status = #final
...
Instance: AtApsExampleBundle02-diagnostic-result-4
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* language = #de-AT
* status = #final
...
Instance: AtApsExampleBundle02-diagnostic-result-5
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* status = #final
* category[0] = $elga-laborparameterergaenzung#05180 "Klinische Chemie"
...
Instance: AtApsExampleBundle02-diagnostic-result-6
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* language = #de-AT
* status = #final
...
Instance: AtApsExampleBundle02-diagnostic-result-7
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* language = #de-AT
* status = #final
...
// Instance: AtApsExampleBundle02-diagnostic-result-8
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle02-diagnostic-result-9
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle02-diagnostic-result-10
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle02-diagnostic-result-11
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle02-diagnostic-result-12
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle02-diagnostic-result-13
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $observation-category#laboratory "Laboratory"
...
// Instance: AtApsExampleBundle02-diagnostic-result-14
// InstanceOf: AtApsObservationResultsLaboratoryPathology
// Usage: #inline
// * status = #final
// * category = $observation-category#laboratory "Laboratory"
...
Instance: AtApsExampleBundle02-diagnostic-result-15
InstanceOf: AtApsObservationResultsLaboratoryPathology
Usage: #inline
* status = #final
* category[0] = $elga-laborparameterergaenzung#05180 "Klinische Chemie"
...
Instance: AtApsExampleBundle02-diagnostic-result-performer-1
...
Instance: AtApsExampleBundle02-vital-sign-1
...
Instance: AtApsExampleBundle02-vital-sign-2
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $observation-category#vital-signs "Vital Signs"
...
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
* performer = Reference(urn:uuid:75db30ee-7028-486c-929a-c5126837f472) "Dr. Hannes Hausarzt"
* effectiveDateTime = "2024-02-08T08:30:00+01:00"
* valueQuantity = 68 'kg' "kg"

Instance: AtApsExampleBundle02-vital-sign-3
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $observation-category#vital-signs "Vital Signs"
...
Instance: AtApsExampleBundle02-vital-sign-4
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $observation-category#vital-signs "Vital Signs"
...
Instance: AtApsExampleBundle02-vital-sign-5
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $observation-category#vital-signs "Vital Signs"
...
Instance: AtApsExampleBundle02-vital-sign-6
InstanceOf: AtApsObservationVitalSigns
Usage: #inline
* status = #final
* category[VSCat] = $observation-category#vital-signs "Vital Signs"
* code = $sct#276361009 "Umfang der Taille"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"
* performer = Reference(urn:uuid:75db30ee-7028-486c-929a-c5126837f472) "Dr. Hannes Hausarzt"
* effectiveDateTime = "2024-02-08T08:30:00+01:00"
...
Instance: AtApsExampleBundle02-illness-history-1
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#resolved "Resolved"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#161419000 "Zustand nach Masern"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

Instance: AtApsExampleBundle02-illness-history-2
InstanceOf: AtApsCondition
Usage: #inline
* clinicalStatus = $condition-clinical#resolved "Resolved"
* verificationStatus = $condition-ver-status#confirmed "Confirmed"
* category.coding[0] = $condition-category#problem-list-item "Problem List Item"
* code = $sct#161423008 "Zustand nach Windpocken"
* subject = Reference(urn:uuid:0fed5ebe-ca8f-4ad1-aba4-ddad45bd6cc8) "Test Arnold"

// Social History

Instance: AtApsExampleBundle02-social-history-1
...
* performer = Reference(urn:uuid:75db30ee-7028-486c-929a-c5126837f472) "Dr. Hannes Hausarzt"
* effectiveDateTime = "2024-02-08T08:30:00+01:00"
* valueCodeableConcept = $sct#266919005 "Nie Tabak geraucht"

Instance: AtApsExampleBundle02-social-history-2
InstanceOf: Observation
Usage: #inline
* status = #final
...
Instance: AtApsExampleBundle02-custodian
InstanceOf: AtApsOrganization
Usage: #inline
